...
// размерах и всё равно мылить между ними. Исключение одно — MAL:
// вектора у него нет вовсе, а картинка лежит вчетверо крупнее знака
// на плите и запаса хватает на любой масштаб окна. Вторая растровая
// картинка в оболочке — иконка самого приложения (AppMark.vue).
//
