...
import { useBoardFlow } from './media-board'
...
/** Ссылка на доску плиток: её ширину и высоты плиток меряет поток. */
...
// Плитки раскладываются по измерению, а не по рубежам ширины в CSS:
// шаблоны областей оставляли под коротким описанием чёрный прогал.
useBoardFlow(board)
